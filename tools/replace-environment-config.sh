...
env_vars='GOOGLE_API_KEY ALGOLIA_INDEX_PREFIX ALGOLIA_APPLICATION_ID ALGOLIA_READ_ONLY_API_KEY MOHCD_SUBDOMAIN MOHCD_DOMAIN SFFAMILIES_DOMAIN LINKSF_DOMAIN'
