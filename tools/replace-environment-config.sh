...
env_vars='AUTH0_AUDIENCE AUTH0_CLIENT_ID AUTH0_DOMAIN AUTH0_REDIRECT_URI GOOGLE_API_KEY ALGOLIA_INDEX_PREFIX ALGOLIA_APPLICATION_ID ALGOLIA_READ_ONLY_API_KEY'
