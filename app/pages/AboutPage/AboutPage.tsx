...
export const AboutPage = () => {
  ...
  let aboutPageMarkup = <div className={styles.about}>
  ...
  if (title === 'Link SF') {
    aboutPageMarkup = <div className={styles.about}>
      <article className={styles.textPage} id="about">
        <header className={styles.aboutHeader}>
          <h1>
            About Link-SF
        ...
        <section className={styles.aboutSection}>
          ...
          <div className={styles.aboutRow}>
            ...
            <p>
              St. Anthony’s <a href="https://www.tenderlointechnologylab.org/" rel="noopener norefferer">Tenderloin Technology Lab (TTL)</a> is the neighborhood’s only free technology center, providing computer access and education to all. Committed to bridging the digital divide, we believe that everyone deserves access to the tools of modern life — whether they want to build employment skills, access other free resources in the Bay Area, or connect and reconnect with family and friends. The TTL was a founding partner in the creation of Link-SF.
            </p>
          </div>
