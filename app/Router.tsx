...
import { ListingsSecondaryNavigationInnerLayout } from "components/ui/ListingsSecondaryNavigationInnerLayout";
  ...
  return (
    <Switch>
      ...
      <Route
        exact
        path="/search"
        component={ListingsSecondaryNavigationInnerLayout}
      />
      <Route
        exact
        path="/services/:id"
