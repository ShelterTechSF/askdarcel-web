...
export function VoteButtons({ vote, onVoteChange }) {
  return (
    <>
...
export function FeedbackTags({ tagOptions, onSelectTag }) {
  return (
...
export function Review({ reviewValue, onReviewChange, isReviewRequired }) {
  return (
...
export function SubmitMessage({ closeModal }) {
  return (
    <>
